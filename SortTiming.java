 ...
 * The time that each sorting algorithm takes will be displayed on the screen and also saved to a file "out.txt"
 *
 * The output format of out.txt for each line is below. 
 *      Size InPlaceInsertion InPlaceSelection HeapPQSort MergeSort QuickSort
 *     
 * 
 * You can import out.txt to excel or other tools to plot the time graphs. 
 * 
...
public class SortTiming {
	...
	public static void main(String [] args){
		...
		try {
			...
			out.write("Size InPlaceInsertion InPlaceSelection HeapPQSort MergeSort QuickSort\n");
			...
			for (int size=1000; size<=maximum; size = size+1000) {
				...
				out.write(" " + String.format("%.0f", avgtime));
				System.out.println(" HeapPQSort: " + String.format("%.0f", avgtime));
